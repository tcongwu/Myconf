...
<table width="778" height="31" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="576" class="channel_bar_bg"><div class="fleft sitenav"><a href="<html:rewrite page="/expert/index.jsp"/>"><bean:message key="menu.top.reviewins" bundle="expert"/></a><a class="split"></a><a href="<html:rewrite page="/expert/bid.jsp"/>"><bean:message key="menu.top.bid" bundle="expert"/></a><a class="nav_on"><a class="selected" href="<html:rewrite page="/expert/reviewing.jsp"/>"><bean:message key="menu.top.reviewing" bundle="expert"/></a></a><a href="<html:rewrite page="/expert/reviewed.jsp"/>"><bean:message key="menu.top.reviewed" bundle="expert"/></a><a class="split"></a><a href="<html:rewrite page="/bbs/index.jsp"/>" target="_blank"><bean:message key="menu.top.bbs" bundle="expert"/></a></div></td>
