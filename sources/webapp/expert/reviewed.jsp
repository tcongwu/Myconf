...
//*********************************
%>
<jsp:include page="/expert/sub/mainmenu4.jsp" />
<br>
    ...
    <TR> 
      ...
      <TD width=776 noWrap>
		...
		<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr> 
            <td class="pagecontent_title"><b><bean:message key="menu.top.reviewed" bundle="expert"/></b></td>
          </tr>
        </table>
        <br>
        <table width="88%" border="0" align="center" cellpadding="0" cellspacing="0" class="form">
          <tr> 
            <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="form_note">
                <tr> 
                  <td> <li><bean:message key="page.reviewed.ins1" bundle="expert"/></li>
        ...
        <table width="88%" border="0" align="center" cellpadding="3" cellspacing="1" class="table">
          <tr> 
            ...
            <td width="52%" class="table_head" nowrap><bean:message key="common.text.title" bundle="admin"/></td>
            <td width="36%" nowrap class="table_head"><bean:message key="common.text.subject" bundle="admin"/></td>
          ...
          <tr> 
            ...
            <td align="center" class="table_cell"><a title="<bean:message key="common.text.modify"/>" href="javascript:reviewPaper(<%=review.getId()%>)"><img src="<html:rewrite page="/images/review.gif"/>" width="20" height="22" border="0"></a> 
            </td>
          </tr>
          <%}%>
        </table>
