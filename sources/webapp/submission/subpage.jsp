    ...
    <TR> 
      ...
      <TD width=776 vAlign=top noWrap>
          ...
          <table width="88%" border="0" align="center" cellpadding="0" cellspacing="0" class="form_row">
            <tr> 
              <td width="20%" class="form_row_title">*<bean:message key="page.subpage.form.title" bundle="author"/></td>
              <td width="80%" class="form_row_content"><input name="title" type="text" id="title" size="80"> 
                &nbsp;</td>
            </tr>
          </table>
          <table width="88%" border="0" align="center" cellpadding="0" cellspacing="0" class="form_row">
            <tr> 
              <td width="20%" class="form_row_title">*<bean:message key="page.subpage.form.subject" bundle="author"/></td>
              <td width="80%" class="form_row_content"><select name="subject" id="subject">
          ...
          <table width="88%" border="0" align="center" cellpadding="0" cellspacing="0" class="form_row">
            <tr> 
              <td width="20%" class="form_row_title">*<bean:message key="page.subpage.form.abstract" bundle="author"/></td>
              <td width="80%" class="form_row_content">&nbsp;&nbsp;<bean:message key="page.subpage.form.abstract.ins" bundle="author"/></strong></td>
            </tr>
          </table>
          <table width="88%" border="0" align="center" cellpadding="0" cellspacing="0" class="form_row">
            <tr> 
