...
public class _logo_0login__jsp extends com.caucho.jsp.JavaPage{
    ...
    throws javax.servlet.ServletException
  {
    ...
    _caucho_line_map = new com.caucho.java.LineMap("_logo_0login__jsp.java", "/myconf/inc/logo_login.jsp");
    _caucho_line_map.add(1, 1);
    _caucho_line_map.add(1, 29);
    _caucho_line_map.add(6, 32);
    _caucho_line_map.add(12, 44);
    com.caucho.vfs.Depend depend;
    depend = new com.caucho.vfs.Depend(appDir.lookup("inc/logo_login.jsp"), 1176214238000L, 656L);
