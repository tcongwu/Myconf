...
public class _logo_0expert__jsp extends com.caucho.jsp.JavaPage{
    ...
    throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    try {
      ...
      if (_jsp_tag1 == null) {
        ...
        _jsp_tag1.setKey("module.expert");
      }
    ...
    throws javax.servlet.ServletException
  {
    ...
    _caucho_line_map = new com.caucho.java.LineMap("_logo_0expert__jsp.java", "/myconf/inc/logo_expert.jsp");
    _caucho_line_map.add(1, 1);
    _caucho_line_map.add(1, 29);
    _caucho_line_map.add(6, 32);
    _caucho_line_map.add(12, 44);
    com.caucho.vfs.Depend depend;
    depend = new com.caucho.vfs.Depend(appDir.lookup("inc/logo_expert.jsp"), 1176214230000L, 657L);
