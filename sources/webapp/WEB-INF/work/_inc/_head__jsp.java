...
public class _head__jsp extends com.caucho.jsp.JavaPage{
    ...
    throws javax.servlet.ServletException
  {
    ...
    _caucho_line_map = new com.caucho.java.LineMap("_head__jsp.java", "/conf1/inc/head.jsp");
    _caucho_line_map.add(1, 1);
    _caucho_line_map.add(1, 29);
    _caucho_line_map.add(8, 43);
    _caucho_line_map.add(9, 55);
    _caucho_line_map.add(10, 61);
    com.caucho.vfs.Depend depend;
    depend = new com.caucho.vfs.Depend(appDir.lookup("inc/head.jsp"), 1186327049953L, 683L);
