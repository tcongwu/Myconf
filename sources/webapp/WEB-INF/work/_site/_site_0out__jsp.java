...
public class _site_0out__jsp extends com.caucho.jsp.JavaPage{
...
//*********************************
    ...
    throws javax.servlet.ServletException
  {
    ...
    _caucho_line_map = new com.caucho.java.LineMap("_site_0out__jsp.java", "/myconf/site/site_out.jsp");
    _caucho_line_map.add(16, 1);
    _caucho_line_map.add(2, 30);
    _caucho_line_map.add(7, 36);
    _caucho_line_map.add(8, 46);
    _caucho_line_map.add(9, 50);
    com.caucho.vfs.Depend depend;
    depend = new com.caucho.vfs.Depend(appDir.lookup("site/site_out.jsp"), 1180752530000L, 712L);
