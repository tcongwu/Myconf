	...
	<form name="formContent" action="<html:rewrite page="/content.do"/>"    method="post"   onSubmit="return checkForm();">
	  ...
	  <div class="spacer_1"></div>
	    ...
	    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="form_row">
                <tr>
                  <td width="18%" class="form_row_title">*<bean:message key="page.site.content_title1" bundle="site" /> </td>
                  <td width="82%" class="form_row_content">&nbsp;
	    ...
	    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="form_row" >
                <tr>
                  <td width="18%" class="form_row_title"><bean:message key="page.site.content_attach" bundle="site" />   </td>
                  <td width="82%" class="form_row_content">&nbsp;
	     ...
	     <table width="100%" border="0" cellpadding="0" cellspacing="0" class="form_row" >
                <tr>
                  <td width="18%" class="form_row_title"> <bean:message key="page.site.menu_published" bundle="site" /></td>
                  <td width="82%" class="form_row_content">&nbsp;&nbsp;
