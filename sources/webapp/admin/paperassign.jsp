  ...
  <tr> 
    <td valign="top" class="pagecontent"><form action="<html:rewrite page="/paper.do"/>" method="post" name="assign" id="assign">
        ...
        <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="form_row">
          <tr> 
            <td width="18%" class="form_row_title"><bean:message key="page.paperassign.title.title" bundle="admin"/></td>
        ...
        <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="form_row">
          <tr> 
            <td width="18%" class="form_row_title"><bean:message key="page.paperassign.title.author" bundle="admin" arg0="<%=String.valueOf(author.getOrderNo())%>"/></td>
        ...
        <table id="confirm" width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="form_row">
          <tr> 
            <td width="18%" valign="top" class="form_row_title"><bean:message key="page.paperassign.title.abstract" bundle="admin"/></td>
            <td class="form_row_content_abstract"><font color="#000000"><pre><%=paper.getAbstr()%></pre></td>
          </tr>
        </table>
        <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="form_row">
          <tr> 
            <td width="18%" class="form_row_title"><bean:message key="page.paperassign.title.bid" bundle="admin"/></td>
        ...
        <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="form_row">
          <tr> 
            <td width="18%" class="form_row_title"><bean:message key="common.text.quitexpert" bundle="admin"/></td>
        ...
        <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="form_row">
          <tr> 
            <td width="18%" class="form_row_title"><bean:message key="page.paperassign.title.expert" bundle="admin"/></td>
