  ...
  <tr>
	...
	function paperAssign(pid) {
	  ...
	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td align="right" class="pagecontent_right"><span class="pagemenu_visited"><bean:message key="menu.paper.top.all" bundle="admin"/>(<%=stats[0]%>)</span> 
          ...
          <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="form_note">
              <tr>
                <td><div class="spacer_5"></div>
				  <li><bean:message key="page.paper.ins1" bundle="admin"/></li>
                  <li><bean:message key="page.paper.ins2" bundle="admin"/></li>
                  <li><bean:message key="page.paper.ins3" bundle="admin"/></li>
                  <li><bean:message key="page.paper.ins4" bundle="admin"/></li>
				  <li><bean:message key="page.paper.ins5" bundle="admin"/></li>
                  <div class="spacer_5"></div></td>
              </tr>
            </table>
            <form action="<html:rewrite page="/admin/paper.jsp"/>" method="post" name="search" id="search">
	        <input name="fromPage" type="hidden" id="fromPage" value="/admin/paper.jsp">
              <table width="100%" border="0" cellspacing="0" cellpadding="0" class="form_row">
                <tr> 
                  <td width="22%" class="form_row_title"><bean:message key="page.paper.title.no" bundle="admin"/></td>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0" class="form_row">
                <tr> 
                  <td width="22%" class="form_row_title"><bean:message key="page.paper.title.subject" bundle="admin"/></td>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0" class="form_row">
                <tr> 
                  <td width="22%" class="form_row_title"><bean:message key="page.paper.title.keyword" bundle="admin"/></td>
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="0" style="border-bottom:#cccccc 1px solid">
              <tr> 
                <td align="right" nowrap><%=pg.getControlPane(request, "/admin/paper.jsp")%></td>
              </tr>
            </table>
            <%}else{%>
