  ...
  <tr> 
    <td valign="top" class="pagecontent">
      ...
      <table width="96%" border="0" align="center" cellpadding="3" cellspacing="1" class="table">
	    ...
	    %>
        <tr> 
          <td class="table_cell"><%if(bbs.getIsTop()==BBSBean.TRUE){%><font color=red><strong><bean:message key="common.text.bbs.top"/></strong></font><%}%><a class="blue" href="<html:rewrite page="/bbs/view.jsp?id="/><%=bbs.getId()%>&page=<%=pg.getCurPage()%>"><%=bbs.getTitle()%></a></td>
      ...
      <table width="96%" border="0" align="center" cellpadding="5" cellspacing="0" style="border-bottom:#cccccc 1px solid">
        <tr> 
          <td align="right" nowrap><%=pg.getDigitalPane(request, "/bbs/index.jsp")%></td>
        </tr>
      </table>
      <%}else{%>
      ...
      <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr> 
          <td> &nbsp; <input name="Button" type="button" class="button" onClick="window.location='<html:rewrite page="/bbs/begin.jsp?page="/><%=pg.getCurPage()%>'" value="<bean:message key="common.button.issue.talk"/>"> 
