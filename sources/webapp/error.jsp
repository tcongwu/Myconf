...
<TABLE width=778 border=0 align="center" cellPadding=0 cellSpacing=0 summary=null>
  <TBODY>
    <TR> 
      <TD height=38 colSpan=2 align="center" noWrap bgcolor="#D3D3DF"><input name="home" type="button" id="home" style="width:130px;height:24px;" onClick="window.location='<html:rewrite page="/"/>'" value="<bean:message key="common.button.home"/>">
        ...
        <input name="back" type="button" id="back" style="width:130px;height:24px;" onClick="window.history.back()" value="<bean:message key="common.button.back"/>"> <SPACER height="10" 
  type="block"></TD>
    </TR>
  </TBODY>
</TABLE>
