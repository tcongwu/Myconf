...
public class _index__jsp extends com.caucho.jsp.JavaPage{
    ...
    throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    try {
      ...
      out.print((pageContext.getServletContext().getRealPath("/lyfcounter.txt")));
    ...
    throws javax.servlet.ServletException
  {
    ...
    _caucho_line_map = new com.caucho.java.LineMap("_index__jsp.java", "/myconf/index.jsp");
    _caucho_line_map.add(1, 1);
    _caucho_line_map.add(1, 26);
    _caucho_line_map.add(9, 28);
    _caucho_line_map.add(10, 30);
    com.caucho.vfs.Depend depend;
    depend = new com.caucho.vfs.Depend(appDir.lookup("index.jsp"), 1176612440278L, 321L);
