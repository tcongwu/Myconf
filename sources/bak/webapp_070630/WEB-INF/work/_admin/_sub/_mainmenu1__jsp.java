...
public class _mainmenu1__jsp extends com.caucho.jsp.JavaPage{
    ...
    throws javax.servlet.ServletException
  {
    ...
    _caucho_line_map = new com.caucho.java.LineMap("_mainmenu1__jsp.java", "/myconf/admin/sub/mainmenu1.jsp");
    ...
    com.caucho.vfs.Depend depend;
    depend = new com.caucho.vfs.Depend(appDir.lookup("admin/sub/mainmenu1.jsp"), 1179493264000L, 2102L);
  ...
  static {
    try {
      _jsp_string9 = "<option value=\"admin\">".getBytes("UTF8");
      _jsp_string5 = "\" target=\"_blank\">".getBytes("UTF8");
      _jsp_string12 = "<option value=\"expert\">".getBytes("UTF8");
      _jsp_string6 = "</a></div></td>\r\n    <td width=\"310\" style=\"PADDING-TOP: 2px;\" align=\"right\" class=\"channel_bar_bg\">\r\n	  <select name=\"select\"onChange=\"if(this.value.length>0){window.location='".getBytes("UTF8");
      _jsp_string10 = "</option>".getBytes("UTF8");
      _jsp_string4 = "</a><a class=\"split\"></a><a href=\"".getBytes("UTF8");
      _jsp_string2 = "\">".getBytes("UTF8");
      _jsp_string0 = "\r\n".getBytes("UTF8");
      _jsp_string11 = "\r\n        ".getBytes("UTF8");
      _jsp_string13 = "<option value=\"site\">".getBytes("UTF8");
      _jsp_string3 = "</a></a><a href=\"".getBytes("UTF8");
      _jsp_string14 = "<option value=\"author\">".getBytes("UTF8");
      _jsp_string8 = "</option>\r\n        ".getBytes("UTF8");
      ...
      _jsp_string7 = "?eventSubmit_SelectRole&rid='+this.value;}\">\r\n        <option selected>".getBytes("UTF8");
