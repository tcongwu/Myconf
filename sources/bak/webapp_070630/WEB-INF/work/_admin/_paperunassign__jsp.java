...
public class _paperunassign__jsp extends com.caucho.jsp.JavaPage{
...
//*********************************
      ...
      _jsp_tag2.setKey("page.paperunassign.ins1");
      _jsp_tag2.doStartTag();
      pageContext.write(_jsp_string14, 0, _jsp_string14.length);
      _jsp_tag2.setKey("page.paperunassign.ins2");
      _jsp_tag2.doStartTag();
      ...
      int _jspEval78 = _jsp_tag1.doStartTag();
      int _jsp_endTagVar79 = _jsp_tag1.doEndTag();
      ...
      int _jspEval97 = _jsp_tag1.doStartTag();
      int _jsp_endTagVar98 = _jsp_tag1.doEndTag();
      ...
      int _jspEval104 = _jsp_tag1.doStartTag();
      int _jsp_endTagVar105 = _jsp_tag1.doEndTag();
      ...
      int _jspEval123 = _jsp_tag1.doStartTag();
      int _jsp_endTagVar124 = _jsp_tag1.doEndTag();
      if (_jsp_endTagVar124 == javax.servlet.jsp.tagext.Tag.SKIP_PAGE)
        return;
      pageContext.write(_jsp_string52, 0, _jsp_string52.length);
      }
      pageContext.write(_jsp_string53, 0, _jsp_string53.length);
      out.print((pg.getControlPane(request, "/admin/paperunassign.jsp")));
...
//**********************************
    ...
    throws javax.servlet.ServletException
  {
    ...
    _caucho_line_map = new com.caucho.java.LineMap("_paperunassign__jsp.java", "/myconf/admin/paperunassign.jsp");
    ...
    _caucho_line_map.add(83, 148);
    _caucho_line_map.add(83, 151);
    ...
    _caucho_line_map.add(101, 200);
    _caucho_line_map.add(105, 206);
    _caucho_line_map.add(107, 209);
    _caucho_line_map.add(112, 212);
    _caucho_line_map.add(114, 215);
    _caucho_line_map.add(115, 224);
    _caucho_line_map.add(121, 231);
    _caucho_line_map.add(121, 233);
    _caucho_line_map.add(122, 235);
    _caucho_line_map.add(128, 237);
    _caucho_line_map.add(130, 247);
    _caucho_line_map.add(135, 250);
    _caucho_line_map.add(155, 259);
    _caucho_line_map.add(158, 271);
    _caucho_line_map.add(159, 273);
    _caucho_line_map.add(160, 275);
    _caucho_line_map.add(161, 277);
    _caucho_line_map.add(164, 279);
    _caucho_line_map.add(167, 281);
    _caucho_line_map.add(168, 291);
    _caucho_line_map.add(169, 294);
    _caucho_line_map.add(170, 297);
    _caucho_line_map.add(171, 300);
    _caucho_line_map.add(173, 309);
    _caucho_line_map.add(179, 316);
    _caucho_line_map.add(179, 327);
    _caucho_line_map.add(179, 329);
    _caucho_line_map.add(179, 339);
    _caucho_line_map.add(180, 341);
    _caucho_line_map.add(180, 346);
    _caucho_line_map.add(180, 348);
    _caucho_line_map.add(180, 351);
    _caucho_line_map.add(182, 355);
    _caucho_line_map.add(182, 358);
    _caucho_line_map.add(184, 361);
    _caucho_line_map.add(184, 370);
    _caucho_line_map.add(184, 373);
    _caucho_line_map.add(184, 375);
    _caucho_line_map.add(187, 381);
    _caucho_line_map.add(191, 383);
    _caucho_line_map.add(194, 385);
    _caucho_line_map.add(197, 387);
    _caucho_line_map.add(200, 396);
    _caucho_line_map.add(207, 398);
    _caucho_line_map.add(212, 404);
    _caucho_line_map.add(217, 410);
    com.caucho.vfs.Depend depend;
    depend = new com.caucho.vfs.Depend(appDir.lookup("admin/paperunassign.jsp"), 1183085864234L, 10793L);
  ...
  static {
    try {
      _jsp_string49 = "\" onClick=\"return confirm('".getBytes("UTF8");
      ...
      _jsp_string51 = ")\"><img src=\"".getBytes("UTF8");
      ...
      _jsp_string47 = "\" class=\"blue\"><strong>".getBytes("UTF8");
      _jsp_string56 = "\r\n          </td>\r\n        </tr>\r\n      </table> \r\n    </td>\r\n  </tr>\r\n</table>\r\n".getBytes("UTF8");
      _jsp_string50 = "')\" href=\"javascript:delPaper(".getBytes("UTF8");
      _jsp_string40 = "</td>\r\n                <td class=\"table_cell\"><a href=\"".getBytes("UTF8");
      ...
      _jsp_string46 = ")\" title=\"".getBytes("UTF8");
      _jsp_string52 = "\" width=\"21\" height=\"21\" border=\"0\"></a> \r\n                </td>\r\n              </tr>\r\n              ".getBytes("UTF8");
      _jsp_string23 = "\">".getBytes("UTF8");
      _jsp_string48 = "</strong></a>\r\n                </td>\r\n                <td align=\"center\" class=\"table_cell\"><a title=\"".getBytes("UTF8");
