		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="form_note">
              ...
              <form  action="<html:rewrite page="/lang.do"/>"  name="langset"    method="post"   onSubmit="return checkForm();">
               ...
               <input name="fromPage" type="hidden" id="fromPage" value="">
                ...
                <tr>
                  <td width="17%" class="form_row_title">*<bean:message key="page.site.setting_name" bundle="site" /></td>
                ...
                <tr>
                  <td width="17%" class="form_row_title">*<bean:message key="page.site.setting_shortname" bundle="site" /></td>
                  <td width="83%" class="form_row_content">&nbsp;
			    ...
			    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="form_row">
                <tr>
                  <td width="17%" class="form_row_title">*<bean:message key="page.site.setting_copyright" bundle="site" /></td>
                  <td width="83%" class="form_row_content">&nbsp;
			    ...
			    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="form_row">
                <tr>
                  <td width="17%" class="form_row_title">*<bean:message key="page.site.setting_email" bundle="site" /></td>
                  <td width="83%" class="form_row_content">&nbsp;
