...
//paper list
Page pg=PaperDAO.queryPaper(request, PaperBean.PAPER_STATE_NORMAL, RequestUtils.getParam(request, "page", 0), Globals.PAGESIZE_10);
	  ...
	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td align="right" class="pagecontent_right"><a href="<html:rewrite page="/admin/paper.jsp"/>" class="pagemenu"><bean:message key="menu.paper.top.all" bundle="admin"/>(<%=stats[0]%>)</a> 
            > <span class="pagemenu_visited"><bean:message key="menu.paper.top.not.assign" bundle="admin"/>(<%=stats[PaperBean.PAPER_STATE_NORMAL]%>)</span> 
          ...
          <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="form_note">
              <tr>
                <td><div class="spacer_5"></div>
				  <li><bean:message key="page.paperunassign.ins1" bundle="admin"/></li>
                  <li><bean:message key="page.paperunassign.ins2" bundle="admin"/></li>
				  <li><bean:message key="page.paper.ins5" bundle="admin"/></li>
                  <div class="spacer_5"></div></td>
              </tr>
            </table>
            <form action="<html:rewrite page="/admin/paperunassign.jsp"/>" method="post" name="search" id="search">
            ...
            <form action="<html:rewrite page="/paper.do"/>" method="post" name="del" id="del">
		        <input name="fromPage" type="hidden" id="fromPage" value="/admin/paperunassign.jsp">
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="0" style="border-bottom:#cccccc 1px solid">
              <tr> 
                <td align="right" nowrap><%=pg.getControlPane(request, "/admin/paperunassign.jsp")%></td>
              </tr>
            </table>
            <%}else{%>
