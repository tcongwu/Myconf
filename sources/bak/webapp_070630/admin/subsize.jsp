	  ...
	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td align="right" class="pagecontent_right"><a href="<html:rewrite page="/admin/subins.jsp"/>" class="pagemenu"><bean:message key="menu.sub.top.ins" bundle="admin"/></a> > 
            ...
            <span class="pagemenu_visited"><bean:message key="menu.sub.top.size" bundle="admin"/></span> > 
          ...
          <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="form_note">
              <tr>
                <td><div class="spacer_5"></div>
				  <li><bean:message key="page.subsize.ins1" bundle="admin"/></li>
                  <li><bean:message key="page.subsize.ins2" bundle="admin"/></li>
				  <div class="spacer_5"></div></td>
              </tr>
            </table>
            <form action="<html:rewrite page="/config.do"/>" method="post" name="sz" id="sz">
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0" class="form_row">
                <tr>
                  <td width="20%" class="form_row_title"><bean:message key="page.subsize.title.size" bundle="admin"/></td>
                  <td class="form_row_content">&nbsp;
                    <input name="subSize" type="text" id="subSize" size="8" value="<%=size%>">
                    &nbsp;{M}</td>
                </tr>
              </table>
              <table width="100%" border="0" cellpadding="0" cellspacing="0" class="form_row">
                <tr> 
                  <td class="form_row_submit"><input onClick="sz.fromPage.value='/admin/subsize.jsp';" name="save" type="submit" class="button" id="save" value="<bean:message key="common.button.save"/>">
                    <input onClick="sz.fromPage.value='/admin/subdate.jsp';" name="next" type="submit" class="button" id="next" value="<bean:message key="common.button.save.and.next"/>">
                  </td>
                </tr>
              </table>
            </form>
