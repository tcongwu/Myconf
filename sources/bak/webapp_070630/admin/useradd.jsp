  ...
  <tr>
	...
	function checkForm()
	{
	  ...
	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td class="pagecontent_title"><b><bean:message key="menu.left.add.user" bundle="admin"/></b></td>
        </tr>
        <tr> 
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="form">
        <tr>
          <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="form_note">
            ...
            <form action="<html:rewrite page="/user.do"/>" method="post" onSubmit="return checkForm()" name="adduser" id="adduser">
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0" class="form_row">
                <tr> 
                  <td nowrap class="form_row_submit"><input name="sub" type="submit" class="button" id="sub" value="<bean:message key="common.button.add.user"/>">
                  </td>
                </tr>
              </table>
            </form>
