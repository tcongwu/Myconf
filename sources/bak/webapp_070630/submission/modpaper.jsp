...
<body<%if(conf!=null && (conf.isStage()==ConfigBean.STAGE_SUBMISSION || conf.isStage()==ConfigBean.STAGE_CONFIRM)){%> onLoad="init();"<%}%>>
<%
//*********************************
//top
//*********************************
...
function init()
{
	<%
	  ...
	  for(i=0;i<authors.size();i++){
	  	...
	  	j=i+1;
	%>
	subform.authorFirstName<%=j%>.value='<%=StringUtils.exportString(author.getFirstName())%>';
	subform.authorLastName<%=j%>.value='<%=StringUtils.exportString(author.getLastName())%>';
	subform.authorEmail<%=j%>.value='<%=StringUtils.exportString(author.getEmail())%>';
	subform.authorInstitute<%=j%>.value='<%=StringUtils.exportString(author.getInstitute())%>';
	<%}%>
	subform.title.value='<%=StringUtils.exportString(paper.getTitle())%>';
	subform.subject.value='<%=paper.getSubject().getId()%>';
	
	subform.ctitle.value='<%=StringUtils.exportString(user.getName().getTitle())%>';
	subform.country.value='<%=StringUtils.exportString(user.getCountry())%>';
  ...
  <TBODY>
    ...
    <TR> 
      ...
      <TD width=776 vAlign=top noWrap>
          ...
          <table width="88%" border="0" align="center" cellpadding="0" cellspacing="0" class="form_row">
            <tr> 
              <td class="form_row_content"> <div class="spacer_5"></div>
                <textarea name="abstr" id="abstr" style="width:80%;height:280px"><%=StringUtils.exportString(paper.getAbstr())%></textarea> 
          ...
          <br>
          <input name="asum" type="hidden" id="asum" value="<%=authors.size()%>">
          <table width="88%" border="0" align="center" cellpadding="0" cellspacing="0" class="form">
            <tr> 
              <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="form_note">
                  <tr> 
          ...
          <table width="88%" border="0" align="center" cellpadding="0" cellspacing="0" class="form_row">
            <tr> 
              ...
              <td width="30%" class="form_row_grid"><input name="firstName" type="text" id="firstName" size="26" value="<%=StringUtils.exportString(user.getName().getFirstName())%>"></td>
              <td width="20%" class="form_row_title"><bean:message key="page.subpage.form.fax" bundle="author"/></td>
              <td width="30%" class="form_row_content"><input name="fax" type="text" id="fax" size="26" value="<%=StringUtils.exportString(user.getFax())%>"></td>
            </tr>
          </table>
          <table width="88%" border="0" align="center" cellpadding="0" cellspacing="0" class="form_row">
            <tr> 
              <td width="20%" height="25" class="form_row_title">*<bean:message key="page.subpage.form.lastname" bundle="author"/></td>
              <td width="30%" class="form_row_grid"><input name="lastName" type="text" id="lastName" size="26" value="<%=StringUtils.exportString(user.getName().getLastName())%>"></td>
              <td width="20%" class="form_row_title">*<bean:message key="page.subpage.form.address" bundle="author"/></td>
              <td width="30%" class="form_row_content"><input name="address" type="text" id="address" size="26" value="<%=StringUtils.exportString(user.getAddress())%>"></td>
            </tr>
          </table>
          <table width="88%" border="0" align="center" cellpadding="0" cellspacing="0" class="form_row">
            <tr> 
              <td width="20%" height="25" class="form_row_title">*<bean:message key="page.subpage.form.worklocation" bundle="author"/></td>
              <td width="30%" class="form_row_grid"><input name="workLocation" type="text" id="workLocation" size="26" value="<%=StringUtils.exportString(user.getWorkLocation())%>"></td>
              <td width="20%" class="form_row_title"><bean:message key="page.subpage.form.state" bundle="author"/></td>
              <td width="30%" class="form_row_content"><input name="state" type="text" id="state" size="26" value="<%=StringUtils.exportString(user.getState())%>"></td>
            </tr>
          </table>
          <table width="88%" border="0" align="center" cellpadding="0" cellspacing="0" class="form_row">
            <tr> 
              <td width="20%" height="25" class="form_row_title"><bean:message key="page.subpage.form.research" bundle="author"/></td>
              <td width="30%" class="form_row_grid"><input name="research" type="text" id="research" size="26" value="<%=StringUtils.exportString(user.getResearch())%>"></td>
          ...
          <table width="88%" border="0" align="center" cellpadding="0" cellspacing="0" class="form_row">
            <tr> 
              ...
              <td width="30%" class="form_row_grid"><input name="phone" type="text" id="phone" size="26" value="<%=StringUtils.exportString(user.getPhone())%>"></td>
              <td width="20%" class="form_row_title">*<bean:message key="page.subpage.form.postcode" bundle="author"/></td>
              <td width="30%" class="form_row_content"><input name="postcode" type="text" id="postcode" size="26" value="<%=StringUtils.exportString(user.getPostcode())%>"></td>
            </tr>
          </table>
          <table width="88%" border="0" align="center" cellpadding="0" cellspacing="0" class="form_row">
            <tr> 
          ...
          <table width="88%" border="0" align="center" cellpadding="0" cellspacing="0" class="form_row">
            <tr> 
              <td class="form_row_content">&nbsp;&nbsp;<span class="blackbold"><bean:message key="page.modpaper.upload" bundle="author"/></span></td>
            </tr>
          </table>
          <table width="88%" border="0" align="center" cellpadding="0" cellspacing="0" class="form_row">
            <tr> 
              <td height="25" class="form_row_content">
			  	...
			  	<input name="pfile" type="file" id="pfile" size="58">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <a href="<html:rewrite page="/viewpaper.jsp?id="/><%=paper.getId()%>" target="_blank" class="blue"><bean:message key="page.modpaper.check" bundle="author"/></a>
          ...
          <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="line_dashed">
            <tr> 
              <td align="center" class="graybar">
              	<input name="eventSubmit_ModPaper" type="submit" id="eventSubmit_ModPaper" style="width:130px;height:24px;" value="<bean:message key="common.button.modify"/>">
                <input name="back" type="button" id="back" style="width:130px;height:24px;" onClick="window.location='<html:rewrite page="/submission/mypaper.jsp"/>'" value="<bean:message key="common.button.back"/>">
			  </td>
            </tr>
          </table>
        ...
        <%}else{%>
          ...
          <TBODY>
            <TR> 
              <TD align="center" height="180" style="font-size:16px;" class="redins"><bean:message key="error.modpaper.closed"/></TD>
            </TR>
          </TBODY>
        </TABLE>
        <%}%>
